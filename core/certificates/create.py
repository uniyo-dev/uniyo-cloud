...
def generate_creator_certificate(certificate_data, qr_data_uri=None):
    ...
    if cert_type == 'marketing_manager':
        title = 'Marketing Manager Certificate'
        reason = 'In recognition of exceptional leadership in promoting UNIYO.'
        stamp = 'super_admin_stamp.png'
    else:
        title = 'Content Creator Certificate'
        reason = 'In recognition of exceptional contribution to creating educational content.'
        stamp = 'super_admin_stamp.png'
