...
def generate_congratulations_certificate(certificate_data, qr_data_uri=None):
    ...
    if cert_type == 'special_congratulations':
        title = 'Special Congratulations Certificate'
        reason = 'In recognition of your extraordinary achievement. Congratulations!'
        stamp = 'super_admin_stamp.png'
    else:
        title = 'Certificate of Congratulations'
        reason = 'In recognition of your hard work and dedication. Congratulations on your achievement!'
        stamp = 'super_admin_stamp.png'
    ...
    # Border
    border_file = BASE_DIR / 'static' / 'Certificates' / 'other' / 'png_converted' / 'option57_rose_gold_single_line.png'
