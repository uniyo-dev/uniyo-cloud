...
def generate_participation_certificate(certificate_data, qr_data_uri=None):
    ...
    if cert_type == 'excellence':
        ...
        reason = 'For outstanding academic excellence and exceptional performance.'
        stamp = 'super_admin_stamp.png'
    elif cert_type == 'advertiser':
        title = 'Advertiser Certificate'
        reason = 'In recognition of exceptional contribution to advertising UNIYO.'
        stamp = 'super_admin_stamp.png'
    else:
        title = 'Certificate of Participation'
        reason = 'For active participation in the UNIYO community and dedication to learning.'
        stamp = 'super_admin_stamp.png'
    ...
    # Border
    border_file = BASE_DIR / 'static' / 'Certificates' / 'other' / 'png_converted' / 'option45_crimson_red_band.png'
    ...
    c.setLineWidth(1.5)
    c.rect(2*mm, 2*mm, w-4*mm, h-4*mm, fill=False, stroke=True)
